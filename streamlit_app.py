...
with b2:
    st.page_link("pages/3_About.py", label="About", icon="ℹ️", use_container_width=True)
with b3:
    st.page_link("pages/4_Residents.py", label="Residents", icon="🏡", use_container_width=True)
with b4:
    st.page_link("pages/2_Contact.py", label="Contact", icon="✉️", use_container_width=True)
