...
BUSINESS_HOURS = "Monday to Friday, 9:00 a.m. to 5:00 p.m. ET (evenings and weekends by appointment)."
RESPONSE_POLICY = (
...
CREDENTIALS_LINE = "Licensed and insured. Credentials and references available upon request."
...
SERVICES = [
    ...
    {
        "title": "Residents, maintenance, and recovery",
        "body": (
...
HOME_TRUST_POINTS = [
    ...
    ("Screening and compliance", "Structured applications, documentation, and regulatory awareness."),
...
PROCESS_STEPS = [
    ...
    ("2. Scope and agreement", "We align on services, fees, and how you want to be updated."),
